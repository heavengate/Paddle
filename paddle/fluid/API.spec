...
paddle.fluid.layers.group_points (ArgSpec(args=['input', 'idx', 'name'], varargs=None, keywords=None, defaults=(None,)), ('document', '0812895201b473d7289058408568aa89'))
...
paddle.fluid.layers.roi_pool_3d (ArgSpec(args=['input', 'pts_feature', 'boxes3d', 'pool_extra_width', 'sampled_pt_num'], varargs=None, keywords=None, defaults=(1.0, 512)), ('document', '2f34a547727ae9a5a1d662c4c05f81a7'))
...
paddle.fluid.layers.three_nn (ArgSpec(args=['input', 'known', 'eps', 'name'], varargs=None, keywords=None, defaults=(1e-10, None)), ('document', 'f623e79c78e6505c6b31abf9e89351a4'))
paddle.fluid.layers.three_interp (ArgSpec(args=['input', 'weight', 'idx', 'name'], varargs=None, keywords=None, defaults=(None,)), ('document', 'bc683a2984544201a73afba9b8b36054'))
...
paddle.fluid.layers.gather_nd (ArgSpec(args=['input', 'index', 'name'], varargs=None, keywords=None, defaults=(None,)), ('document', '6adf97f83acf6453d4a6a4b1070f3754'))
paddle.fluid.layers.gather_point (ArgSpec(args=['input', 'index'], varargs=None, keywords=None, defaults=None), ('document', 'dad921e3c9fb36db665abedc747a8e93'))
