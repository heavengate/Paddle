...
class DeformableConv2DTestCase(unittest.TestCase):
    def __init__(self,
                 methodName='runTest',
                 batch_size=4,
                 ...
                 modulated=False,
                 dtype="float32"):
        super(DeformableConv2DTestCase, self).__init__(methodName)
    ...
    def fluid_layer(self, place):
        ...
        with fluid.unique_name.guard():
            with fluid.program_guard(main, start):
                input_shape = (-1, self.num_channels, -1, -1)
                ...
                y_var = fluid.layers.deformable_conv(
                    x_var,
                    self.num_filters,
                    self.filter_size,
