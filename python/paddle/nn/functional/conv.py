...
def deformable_conv(input,
    ...
    if in_dygraph_mode() and self._l_type == 'conv2d':
        ...
        if modulated:
            ...
            out = core.ops.deformable_conv(input, offset, mask, weight, *attrs)
        else:
            out = core.ops.deformable_conv_v1(input, offset, weight, *attrs)

        return dygraph_utils._append_bias_in_dygraph(out, bias, 1)
